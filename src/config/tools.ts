...
export const tools: ToolConfig[] = [
  ...
  },
  {
    id: "youtuber-battle",
    name: "유튜버 배틀로얄",
    nameKey: "toolYoutuberBattleName",
    descriptionKey: "toolYoutuberBattleDesc",
    description: "구독자가 체력, 조회수가 화력! 유튜브 채널 데이터로 배틀로얄",
    category: "game",
    icon: "Youtube",
    path: "/tools/youtuber-battle",
    isNew: true,
    isPopular: true,
    keywords: ["유튜버배틀", "유튜버대결", "YouTuber Battle", "구독자대결", "MrBeast", "침착맨", "배틀로얄"],
  },
  {
    id: "work-schedule",
    name: "근무표",
    nameKey: "toolWorkScheduleName",
    descriptionKey: "toolWorkScheduleDesc",
    description: "A·B·C 3개 조의 주간·야간·비번 교대 근무표. 공휴일·D-Day·다크모드 지원",
    category: "lifestyle",
    icon: "CalendarDays",
    path: "/tools/work-schedule",
    isNew: true,
    isPopular: true,
    keywords: ["근무표", "교대근무", "3조2교대", "야간근무", "비번", "근무달력", "shift calendar"],
  },
  {
